  ...
  <div class="home">
    <div class="home__wrapper">
      ...
      <div class="home__inner">
        <h2>Large horizontal table</h2>
        <div>
          <label>
            <input type="checkbox" checked> Home made scroll bar
          </label>
        </div>
        <div>
          <label>
            <input type="checkbox" checked> Scroll bar always visible (sticky)
          </label>
        </div>
        <div>
          <label>
            <input type="checkbox" checked> Left and right shadows when overflowing
          </label>
        </div>
        <div>
          <label>
            <input type="checkbox" checked> Drag the table around with the cursor (like touch)
          </label>
        </div>
        <div>
          <label>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p><strong>Scroll to get to the table 👇</strong></p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
      ...
      <div class="home__inner">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p><strong>More content after</strong></p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus nostrum amet illum, provident itaque voluptate veritatis distinctio consectetur quaerat quas ratione ut accusantium! Ab, expedita hic nisi corrupti iste suscipit.</p>
